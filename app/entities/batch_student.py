...
class BatchStudent(Base):
    ...
    student_id: int = sa.Column(sa.Integer, sa.ForeignKey("users.id"), nullable=False) # type: ignore
    class_fee: int = sa.Column(sa.Integer, nullable=False) # type: ignore
    mentor_fee: int = sa.Column(sa.Integer, nullable=False) # type: ignore
    referral_by: int = sa.Column(sa.Integer, sa.ForeignKey("users.id"), nullable=True)
    referral_fee: int =  sa.Column(sa.Integer, nullable=False, default=0) # type: ignore
