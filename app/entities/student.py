...
class Student(Base):
    ...
    gender: str = sa.Column(sa.String(100), nullable=False) # type: ignore
    email: str = sa.Column(sa.String(100), nullable=False, unique=True) # type: ignore
    phone_number: str = sa.Column(sa.String(100), nullable=False) # type: ignore
    ...
    refered_by: str = sa.Column(sa.String(100), nullable=False) # type: ignore
